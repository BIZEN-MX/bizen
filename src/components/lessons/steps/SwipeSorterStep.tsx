  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <p style={{ fontSize: "clamp(18px, 3.5vw, 22px)", fontWeight: 700, color: "#111827", margin: 0, lineHeight: 1.2 }}>
          {item.label}
        </p>
        {item.sublabel && (
        ...
        {item.amount && (
          <p style={{
            fontSize: 26, fontWeight: 800, color: "#0F62FE", margin: 0,
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24, maxWidth: 480, margin: "0 auto", width: "100%", userSelect: "none" }}>
      ...
      <div style={{ display: "flex", gap: 14 }}>
        <button
          ...
          style={{
            flex: 1, padding: "18px", borderRadius: 20, border: `2px solid ${leftColor}`,
            background: "white", color: leftColor, fontWeight: 800, fontSize: 15, cursor: "pointer",
        ...
        <button
          ...
          style={{
            flex: 1, padding: "18px", borderRadius: 20, border: `2px solid ${rightColor}`,
            background: "white", color: rightColor, fontWeight: 800, fontSize: 15, cursor: "pointer",
            display: "flex", alignItems: "center", justifyContent: "center", gap: 10,

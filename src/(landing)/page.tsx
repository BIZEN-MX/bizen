            ...
            <div className="hero-copy">
              ...
              <div className="hero-actions">
                {loading ? (
                  ...
                  // Authenticated user - redirect to Billy welcome page
                  <>
                    <button 
                      className="btn primary large" 
                      onClick={() => {
                        router.push("/billy-welcome")
                      }}
...
.logo-image{width:40px; height:40px; border-radius:10px; object-fit:contain; display:block; flex-shrink:0;}

...
export const lessonQueEsElDineroParaMiSteps: LessonStep[] = [
  // SLIDE 1 — FLASHCARD (Intro Theory)
  {
    ...
    imageUrl: "/lessons/qed/intro.png",
    imageAlign: "right",
    isAssessment: false,
  ...
  // SLIDE 3 — FLASHCARD (Theory)
  {
    ...
    imageUrl: "/lessons/qed/perception.png",
    imageAlign: "left",
    isAssessment: false,
    continueLabel: "Continuar",
    fullScreen: true,
  ...
  // SLIDE 6 — FLASHCARD (Example Theory)
  {
    ...
    imageUrl: "/lessons/qed/comparison.png",
    imageAlign: "right",
    isAssessment: false,
    continueLabel: "Continuar",
    fullScreen: true,
  ...
  // SLIDE 9 — FLASHCARD (Theory)
  {
    ...
    imageUrl: "/lessons/qed/origins.png",
    imageAlign: "left",
    isAssessment: false,
    continueLabel: "Continuar",
    fullScreen: true,
  ...
  // SLIDE 12 — FLASHCARD (Key Idea)
  {
    ...
    imageUrl: "/lessons/qed/reflection.png",
    imageAlign: "right",
    isAssessment: false,
    continueLabel: "Continuar",
    fullScreen: true,

...
export const lessonLasRulesDelSistemaFinancieroSteps: LessonStep[] = [
  ...
  },
  {
    ...
    body: "Un banco te presta $10,000 pero espera cobrarte $12,000 o más. Esa diferencia es su ganancia. \n\nSu negocio es que **tú debas dinero el mayor tiempo posible**. No quieren que pagues rápido; quieren que pagues intereses mensualmente.",
  ...
  },
  {
    ...
    body: "Tener un buen historial no es para presumir, es para **negociar**. Un buen historial te permite pedir tasas más bajas cuando realmente necesites apalancamiento para un negocio.",

...
export const lessonCapitalIntelectualVsFinancieroSteps: LessonStep[] = [
  ...
  { id: "opt-1-7", stepType: true_false as any, statement: "El capital intelectual es el único que tiene interés compuesto infinito.", correctValue: true, explanation: "El conocimiento se acumula y se mezcla, generando ideas que antes no podías ver. Es exponencial.", isAssessment:true, fullScreen: true },

...
export const lessonDineroYAutoestimaSteps: LessonStep[] = [
    // SLIDE 1 — FLASHCARD (Intro Theory)
    {
        ...
        imageUrl: "/lessons/dya/intro.png",
        imageAlign: "right",
        isAssessment: false,
    ...
    // SLIDE 3 — FLASHCARD (Theory)
    {
        ...
        imageUrl: "/lessons/dya/theory1.png",
        imageAlign: "left",
        isAssessment: false,
        continueLabel: "Continuar",
        fullScreen: true,
    ...
    // SLIDE 6 — FLASHCARD (Example Theory)
    {
        ...
        imageUrl: "/lessons/dya/example.png",
        imageAlign: "right",
        isAssessment: false,
        continueLabel: "Continuar",
        fullScreen: true,
    ...
    // SLIDE 9 — FLASHCARD (Theory)
    {
        ...
        imageUrl: "/lessons/dya/theory2.png",
        imageAlign: "left",
        isAssessment: false,
        continueLabel: "Continuar",
        fullScreen: true,
    ...
    // SLIDE 11 — FLASHCARD (Key Idea)
    {
        ...
        imageUrl: "/lessons/dya/keyidea.png",
        imageAlign: "right",
        isAssessment: false,
        continueLabel: "Continuar",
        fullScreen: true,

...
export default function HistorialDeCuentaPage() {
  ...
  return (
    <div style={{
      ...
      <main style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 20px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 4 }}>
                ...
                <h1 style={{ fontSize: 32, fontWeight: 900, margin: 0, letterSpacing: "-0.03em" }}>Historial de Cuenta</h1>
              </div>
              <p style={{ fontSize: 15, color: "rgba(255,255,255,0.45)", margin: 0, fontWeight: 500 }}>
                Auditoría completa de tus transacciones ráfaga tras ráfaga.
              </p>
            </div>
          </div>
        ...
        {/* ── SEARCH & FILTERS ── */}
        <section style={{ marginBottom: 40, animation: "fadeIn 0.7s ease" }}>
          <div style={{ 
            position: "relative",
            maxWidth: 600
          }}>
            <input 
              type="text" 
              placeholder="Buscar por descripción, tipo o categoría..." 
              value={search}
        ...
        {/* ── TRANSACTION FEED ── */}
        <section style={{ animation: "fadeIn 0.8s ease" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {filtered.length === 0 ? (
              <div style={{ textAlign: "center", padding: "100px 0", background: "rgba(255,255,255,0.02)", borderRadius: 32, border: "2px dashed rgba(255,255,255,0.05)" }}>
                <Search size={48} color="rgba(255,255,255,0.1)" style={{ marginBottom: 16 }} />
                <h3 style={{ fontSize: 20, fontWeight: 700, margin: "0 0 8px" }}>Sin movimientos registrados</h3>
                <p style={{ fontSize: 14, color: "rgba(255,255,255,0.3)" }}>No hay transacciones que coincidan con tu búsqueda.</p>
              </div>
            ) : (
              filtered.map((t, idx) => (
                <motion.div
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: 17, fontWeight: 800, color: "#fff", marginBottom: 4, display: "flex", alignItems: "center", gap: 10 }}>
                      {t.description}
                      {(t.category === 'lesson_reward' || t.category === 'streak_bonus') && (
                        <div style={{ 
                          fontSize: 9, 
                          fontWeight: 900, 
                          color: "#10b981", 
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 5, fontSize: 13, color: "rgba(255,255,255,0.35)", fontWeight: 500 }}>
                        <Calendar size={14} />
                        {new Date(t.createdAt).toLocaleDateString("es-ES", { day: "numeric", month: "long", year: "numeric" })}
                      </div>
                      <div style={{ width: 4, height: 4, borderRadius: "50%", background: "rgba(255,255,255,0.15)" }} />
                      <div style={{ fontSize: 11, color: "rgba(255,255,255,0.25)", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em", display: "flex", alignItems: "center", gap: 5 }}>
                        <Tag size={12} />
                  ...
                  <div style={{ textAlign: "right", minWidth: 100 }}>
                    <div style={{ 
                      fontSize: 22, 
                      fontWeight: 950, 
                      color: (t.category === "transfer_sent" || t.category === "purchase") ? "#ef4444" : "#10b981",
        ...
        <footer style={{ 
          ...
          <div style={{ 
            ...
            <ShieldCheck size={18} />
            Transacciones encriptadas y verificadas por BIZEN Secure Ledger
          </div>
          <p style={{ fontSize: 11, color: "rgba(255,255,255,0.2)", marginTop: 16 }}>
            ID del Libro Mayor: {user?.id.substring(0, 10)}... (Punto de restauración automático activo)
          </p>
        </footer>

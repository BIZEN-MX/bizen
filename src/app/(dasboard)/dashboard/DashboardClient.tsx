...
import { ShoppingBag, Check, History, ArrowUpRight, ArrowDownLeft, Flame, Shield, Target, Coins, BookOpen, TrendingUp, BrainCircuit, ChevronRight, RefreshCw, Newspaper, Trophy, Megaphone } from "lucide-react"
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        >
          ...
          {globalBanner && (
            ...
            >
              <div className={`p-4 sm:px-6 relative flex flex-col sm:flex-row sm:items-center justify-between gap-4 ${globalBanner.color === "orange" ? "bg-gradient-to-r from-orange-500 to-amber-600" :
        ...
        ══════════════════════════════════════════════════════════ */}
          ...
          >
            ...
            <div className="flex items-center justify-between mb-8 px-2">
              <div className="flex items-center gap-5">
                <div className="w-12 h-12 rounded-2xl bg-white border border-slate-200 flex items-center justify-center shadow-sm">
                  <IcoGrid size={24} color="#0F62FE" strokeWidth={2.2} />
                </div>
                <div>

                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
                                <Card style={{ padding: 32 }}>
                                    ...
                                    <div style={{ display: "flex", gap: 16 }}>
                                        <div style={{ width: 60, height: 60, background: "#f1f5f9", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24 }}>🤝</div>
                                        <div style={{ width: 60, height: 60, background: "#f1f5f9", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24 }}>🎓</div>
                                        <div style={{ width: 60, height: 60, background: "#f1f5f9", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24 }}>🌟</div>
                                    </div>
                                </Card>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
                                <Card style={{ padding: 32 }}>
                                    ...
                                    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                                        {[
                                            { icon: "💰", title: "Donación ejecutada", date: "15 Dic", desc: "Se entregaron $15,000 MXN" },
                                            { icon: "🎯", title: "Meta de sesiones lograda", date: "02 Feb", desc: "Promedio >3 sesiones" },
                                            { icon: "🔒", title: "Base asegurada", date: "01 Ene", desc: "Convenio 2026 firmado" }
                                        ].map((item, i) => (

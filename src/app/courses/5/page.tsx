...
export default function Tema5Page() {
  ...
  const openLesson = (lesson: Tema5Lesson, unitTitle: string) => {
    ...
    >
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema5-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

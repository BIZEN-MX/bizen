...
import type { Tema25Lesson } from "../tema25-data"
...
export default function Tema25Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema25Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema25Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA25_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema25-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

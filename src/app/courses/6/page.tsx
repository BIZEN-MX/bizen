...
import type { Tema6Lesson } from "../tema6-data"
...
export default function Tema6Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema6Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema6Lesson, unitTitle: string) => {
    ...
    >
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema6-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

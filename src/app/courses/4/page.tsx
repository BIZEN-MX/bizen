...
import type { Tema4Lesson } from "../tema4-data"
...
export default function Tema4Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema4Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema4Lesson, unitTitle: string) => {
    ...
    >
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema4-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

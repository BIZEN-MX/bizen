...
import type { Tema23Lesson } from "../tema23-data"
...
export default function Tema23Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema23Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema23Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA23_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema23-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

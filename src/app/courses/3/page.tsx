...
import type { Tema3Lesson } from "../tema3-data"
...
export default function Tema3Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema3Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema3Lesson, unitTitle: string) => {
    ...
    >
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema3-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

...
import type { Tema10Lesson } from "../tema10-data"
...
export default function Tema10Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema10Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema10Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA10_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema10-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

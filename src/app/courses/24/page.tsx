...
import type { Tema24Lesson } from "../tema24-data"
...
export default function Tema24Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema24Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema24Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA24_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema24-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

...
import type { Tema26Lesson } from "../tema26-data"
...
export default function Tema26Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema26Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema26Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA26_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema26-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

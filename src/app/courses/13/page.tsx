...
import type { Tema13Lesson } from "../tema13-data"
...
export default function Tema13Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema13Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema13Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA13_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema13-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

...
import type { Tema18Lesson } from "../tema18-data"
...
export default function Tema18Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema18Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema18Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA18_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema18-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

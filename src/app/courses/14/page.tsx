...
import type { Tema14Lesson } from "../tema14-data"
...
export default function Tema14Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema14Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema14Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA14_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema14-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

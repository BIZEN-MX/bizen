...
import type { Tema27Lesson } from "../tema27-data"
...
export default function Tema27Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema27Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema27Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA27_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema27-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

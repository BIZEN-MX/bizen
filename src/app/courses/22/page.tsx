...
import type { Tema22Lesson } from "../tema22-data"
...
export default function Tema22Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema22Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema22Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA22_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema22-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

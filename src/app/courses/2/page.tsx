...
import type { Tema2Lesson } from "../tema2-data"
...
export default function Tema2Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema2Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema2Lesson, unitTitle: string) => {
    ...
    >
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema2-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

...
import type { Tema20Lesson } from "../tema20-data"
...
export default function Tema20Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema20Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema20Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA20_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema20-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

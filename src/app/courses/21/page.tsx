...
import type { Tema21Lesson } from "../tema21-data"
...
export default function Tema21Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema21Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema21Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA21_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema21-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

...
import type { Tema30Lesson } from "../tema30-data"
...
export default function Tema30Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema30Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema30Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA30_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema30-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

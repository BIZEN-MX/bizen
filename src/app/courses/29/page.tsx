...
export default function Tema29Page() {
  ...
  const openLesson = (lesson: Tema29Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA29_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema29-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

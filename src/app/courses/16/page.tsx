...
import type { Tema16Lesson } from "../tema16-data"
...
export default function Tema16Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema16Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema16Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA16_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema16-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

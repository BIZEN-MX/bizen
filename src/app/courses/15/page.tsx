...
import type { Tema15Lesson } from "../tema15-data"
...
export default function Tema15Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema15Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema15Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA15_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema15-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

...
import type { Tema28Lesson } from "../tema28-data"
...
export default function Tema28Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema28Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema28Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA28_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema28-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

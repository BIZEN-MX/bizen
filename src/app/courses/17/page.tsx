...
import type { Tema17Lesson } from "../tema17-data"
...
export default function Tema17Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema17Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema17Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA17_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema17-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

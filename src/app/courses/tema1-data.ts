...
export const TEMA1_SUBTEMAS: Tema1Subtema[] = [
  {
    ...
    lessons: [
      ...
      { title: "Mis primeras creencias sobre el dinero", level: "Básico", slug: "mis-primeras-creencias-sobre-el-dinero" },
      { title: "Expectativas vs realidad financiera", level: "Intermedio", slug: "expectativas-vs-realidad-financiera" },
      { title: "Paciencia financiera y mentalidad a largo plazo", level: "Avanzado", slug: "paciencia-financiera-y-mentalidad-a-largo-plazo" },

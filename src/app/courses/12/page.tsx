...
import type { Tema12Lesson } from "../tema12-data"
...
export default function Tema12Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema12Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema12Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA12_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema12-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

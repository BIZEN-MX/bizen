...
import type { Tema8Lesson } from "../tema8-data"
...
export default function Tema8Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema8Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema8Lesson, unitTitle: string) => {
    ...
    >
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema8-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

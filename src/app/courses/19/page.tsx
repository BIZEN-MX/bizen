...
import type { Tema19Lesson } from "../tema19-data"
...
export default function Tema19Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema19Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema19Lesson, unitTitle: string) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          {TEMA19_SUBTEMAS.map((sub, subIdx) => {
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema19-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

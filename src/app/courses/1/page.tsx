...
export default function Tema1Page() {
  ...
  const openLesson = (lesson: Tema1Lesson, unitTitle: string) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Same structure as courses page: inner div with maxWidth 800, overridden by CSS to use full usable space */}
        <div
          style={{
            width: "100%",
            maxWidth: "800px",
        ...
        >
          ...
          {/* 5 subtopics: each = bar + lessons below (like the 14 courses) */}
          {TEMA1_SUBTEMAS.map((sub, subIdx) => {
            ...
            return (
              ...
              >
                {/* Subtopic bar - same style as course bar */}
                <div
                  style={{
                    display: "flex",
                    flexDirection: "column",
      ...
      {/* Lesson modal - Iniciar / Regresar (same as courses page) */}
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              <Button
                onClick={() => {
                  router.push(`/learn/course-1/unit-1/${lessonModal.slug}/interactive`)
                  setLessonModal(null)
                }}
                style={{
                  width: "100%",
      ...
      <style>{`
        /* Same as courses page: use full usable space (viewport minus sidebar) */

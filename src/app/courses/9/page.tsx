...
import type { Tema9Lesson } from "../tema9-data"
...
export default function Tema9Page() {
  ...
  const [lessonModal, setLessonModal] = useState<Tema9Lesson | null>(null)
  ...
  const openLesson = (lesson: Tema9Lesson, unitTitle: string) => {
    ...
    >
      ...
      {lessonModal && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="tema9-lesson-modal-title"
          style={{
            position: "fixed",
            inset: 0,
            zIndex: 9999,

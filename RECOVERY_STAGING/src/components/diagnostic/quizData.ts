...
export const diagnosticQuiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    label: "Presupuesto",
    level: "Intermedio",
    question: "Sigues un plan de presupuesto mensual. Si ganas $10,000 pero tus gastos en 'Deseos' (entretenimiento, ropa) ya suman $5,000 este mes, ¿qué ajuste es el más recomendable para mantener tu salud financiera?",
    options: [
      { value: "A", text: "Reducir mis Deseos para asegurar un ahorro o inversión de al menos el 20%." },
      { value: "B", text: "Reducir mis necesidades básicas (comida, renta) para no sacrificar mi estilo de vida." },
      { value: "C", text: "No ahorrar este mes y esperar a que el próximo mes me sobre más dinero." },
      { value: "D", text: "Mantener mis gastos igual, ya que el presupuesto es solo una guía flexible." },
    ],
    answer: "A",
  },

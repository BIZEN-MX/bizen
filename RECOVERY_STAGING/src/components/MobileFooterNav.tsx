            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <button
                ...
                style={{
                  ...
                  gap: "14px",
                  padding: "14px 18px",
                  background: pathname === "/bites" ? "rgba(239, 68, 68, 0.08)" : "transparent",
                  border: "none",
                  borderRadius: "16px",
                  cursor: "pointer",
                  fontSize: 16,
                  fontWeight: 600,
                  color: pathname === "/bites" ? "#ef4444" : "#1e293b",
                  width: "100%",
                  textAlign: "left",
                  transition: "all 0.2s ease"
                }}
              >
                <div style={{ width: 36, height: 36, borderRadius: "10px", background: "rgba(239, 68, 68, 0.1)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <PlayIcon size={20} color="#ef4444" strokeWidth={2.5} fill={pathname === "/bites" ? "#ef4444" : "none"} />
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  <span>BIZEN Bites</span>
                  <span style={{ fontSize: 10, fontWeight: 700, color: "#ef4444", background: "rgba(239,68,68,0.12)", padding: "2px 6px", borderRadius: 6 }}>NUEVO</span>
                </div>
              </button>

...
export default function BillyWelcomeScreen({
  ...
  const message = titleMessage
    || (isReturningUser
      ? <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12 }}>{isAnahuac ? "¡Bienvenido de nuevo, León!" : `¡Bienvenido de nuevo, ${userName}!`} <PartyIcon size={40} color="#0F62FE" /></span> as any
      : <span style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12 }}>{isAnahuac ? "¡Bienvenido, León!" : `¡Bienvenido, ${userName}!`} <RocketIcon size={40} color="#0F62FE" /></span> as any)

export const STOCK_METADATA: Record<string, {
  ...
  LLY: { desc: "Eli Lilly and Company. Gigante farmacéutico líder en tratamientos para diabetes y obesidad.", sector: "Salud", risk: "Medio", stats: "Líder en GLP-1" },
  PFE: { desc: "Pfizer Inc. Multinacional farmacéutica conocida por sus vacunas y tratamientos oncológicos.", sector: "Salud", risk: "Medio-Alto", stats: "Especialista en Biotecnología" },
  MCD: { desc: "McDonald's Corporation. El líder mundial en comida rápida con presencia en más de 100 países.", sector: "Consumo", risk: "Bajo", stats: "Modelo inmobiliario robusto" },
  SBUX: { desc: "Starbucks Corporation. La mayor cadena de cafeterías del mundo y líder en lealtad del cliente.", sector: "Consumo", risk: "Medio", stats: "Expansión masiva en China" },
  ORCL: { desc: "Oracle Corporation. Especialista en software de base de datos y computación en la nube.", sector: "Tecnología", risk: "Medio", stats: "Enfoque en Cloud e IA" },
  ADBE: { desc: "Adobe Inc. Creador de Photoshop y líder global en software para diseño creativo y marketing digital.", sector: "Tecnología", risk: "Medio", stats: "Modelo SaaS dominante" },
  AMD: { desc: "Advanced Micro Devices, Inc. Principal competidor de Intel en CPUs y GPUs para PCs y servidores.", sector: "Semiconductores", risk: "Alto", stats: "Crecimiento fuerte en servidores" },
  INTC: { desc: "Intel Corporation. El mayor fabricante mundial de microprocesadores para computadoras.", sector: "Semiconductores", risk: "Alto", stats: "Inversión masiva en fundiciones" },
  ASML: { desc: "ASML Holding. Fabricante único de máquinas de litografía EUV para los chips más avanzados.", sector: "Semiconductores", risk: "Medio", stats: "Monopolio tecnológico vital" },
  SAP: { desc: "SAP SE. Líder europeo en software de gestión empresarial (ERP) para corporaciones globales.", sector: "Software", risk: "Bajo-Medio", stats: "Estándar de industria" },
  TM: { desc: "Toyota Motor Corporation. El mayor fabricante de automóviles del mundo por volumen de ventas.", sector: "Automotriz", risk: "Bajo-Medio", stats: "Líder en híbridos" },
  F: { desc: "Ford Motor Company. Histórico fabricante de autos enfocado en pickups y transición eléctrica.", sector: "Automotriz", risk: "Alto", stats: "F-150 es el auto más vendido" },
  GM: { desc: "General Motors Company. Gigante automotriz dueño de Chevrolet, Cadillac y líder en autónomos.", sector: "Automotriz", risk: "Alto", stats: "Enfoque en plataforma Ultium" },
  SONY: { desc: "Sony Group Corporation. Conglomerado japonés de electrónica, PlayStation, música y cine.", sector: "Tecnología", risk: "Medio", stats: "Dominio en Gaming" },
  BABA: { desc: "Alibaba Group. El gigante del comercio electrónico, computación en la nube y pagos en China.", sector: "E-commerce", risk: "Muy Alto", stats: "El Amazon de Oriente" },
  TCEHY: { desc: "Tencent Holdings. El mayor ecosistema digital de China: WeChat, Gaming y Finanzas.", sector: "Tecnología", risk: "Alto", stats: "Líder mundial en Gaming" },
  UBER: { desc: "Uber Technologies, Inc. Líder global en movilidad, entrega de comida y logística digital.", sector: "Gig Economy", risk: "Alto", stats: "Escala global masiva" },
  ABNB: { desc: "Airbnb, Inc. Plataforma disruptiva que cambió la forma en que el mundo viaja y se hospeda.", sector: "Turismo", risk: "Alto", stats: "Activos ligeros (Asset light)" },
  SPOT: { desc: "Spotify Technology. El servicio de streaming de audio y podcasts más popular del mundo.", sector: "Streaming", risk: "Alto", stats: "Crecimiento en suscriptores" },
  CAT: { desc: "Caterpillar Inc. Fabricante líder mundial de equipos de construcción y minería.", sector: "Industrial", risk: "Medio", stats: "Barómetro de economía mundial" },
  HON: { desc: "Honeywell International. Conglomerado industrial que desarrolla tecnologías aeroespaciales.", sector: "Industrial", risk: "Bajo-Medio", stats: "Muy diversificado" },
  LVMUY: { desc: "LVMH Moët Hennessy Louis Vuitton. El mayor imperio de lujo mundial con 75 casas de prestigio.", sector: "Lujo", risk: "Medio", stats: "Marca premium inalcanzable" },
  BAC: { desc: "Bank of America Corporation. Uno de los bancos más grandes de EE.UU. con gran enfoque minorista.", sector: "Finanzas", risk: "Medio", stats: "Gran portafolio de depósitos" },
  GS: { desc: "The Goldman Sachs Group. El banco de inversión más prestigioso y poderoso de Wall Street.", sector: "Finanzas", risk: "Medio-Alto", stats: "Asesor de las mayores fusiones" },
  PYPL: { desc: "PayPal Holdings, Inc. Pionero mundial en pagos digitales y carteras electrónicas.", sector: "Fintech", risk: "Alto", stats: "Gran red de comercios" },
};
...
export const STOCK_FUNDAMENTALS: Record<string, Fundamentals> = {
  ...
  LLY: {
    marketCap: "760B", pe: 65.4, divYield: 0.7, beta: 0.95,
    week52High: 974.43, week52Low: 550.00, eps: 12.45, revenueGrowthYoY: 36.0,
    ratingLabel: "Compra Fuerte", ratingScore: 5,
  },
  PFE: {
    marketCap: "158B", pe: 10.4, divYield: 5.8, beta: 0.55,
    week52High: 34.00, week52Low: 25.20, eps: 2.50, revenueGrowthYoY: -40.0,
    ratingLabel: "Neutral", ratingScore: 3,
  },
  MCD: {
    marketCap: "212B", pe: 24.5, divYield: 2.3, beta: 0.70,
    week52High: 312.00, week52Low: 245.00, eps: 11.85, revenueGrowthYoY: 4.0,
    ratingLabel: "Compra", ratingScore: 4,
  },
  SBUX: {
    marketCap: "108B", pe: 25.8, divYield: 2.4, beta: 0.95,
    week52High: 107.00, week52Low: 71.00, eps: 3.58, revenueGrowthYoY: 8.0,
    ratingLabel: "Compra", ratingScore: 4,
  },
  ORCL: {
    marketCap: "520B", pe: 35.5, divYield: 0.8, beta: 1.10,
    week52High: 195.00, week52Low: 100.00, eps: 5.20, revenueGrowthYoY: 9.0,
    ratingLabel: "Compra Fuerte", ratingScore: 5,
  },
  ADBE: {
    marketCap: "245B", pe: 32.2, divYield: null, beta: 1.25,
    week52High: 638.00, week52Low: 433.00, eps: 18.20, revenueGrowthYoY: 10.5,
    ratingLabel: "Compra", ratingScore: 4,
  },
  AMD: {
    marketCap: "235B", pe: 45.8, divYield: null, beta: 1.85,
    week52High: 227.00, week52Low: 130.00, eps: 3.45, revenueGrowthYoY: 18.0,
    ratingLabel: "Compra Fuerte", ratingScore: 5,
  },
  INTC: {
    marketCap: "105B", pe: null, divYield: null, beta: 1.15,
    week52High: 51.00, week52Low: 18.50, eps: -0.45, revenueGrowthYoY: -15.0,
    ratingLabel: "Venta", ratingScore: 2,
  },
  ASML: {
    marketCap: "305B", pe: 38.5, divYield: 1.1, beta: 1.35,
    week52High: 1100.00, week52Low: 650.00, eps: 21.40, revenueGrowthYoY: 12.0,
    ratingLabel: "Compra Fuerte", ratingScore: 5,
  },
  SAP: {
    marketCap: "248B", pe: 42.1, divYield: 1.0, beta: 1.05,
    week52High: 232.00, week52Low: 140.00, eps: 5.25, revenueGrowthYoY: 10.0,
    ratingLabel: "Compra", ratingScore: 4,
  },
  TM: {
    marketCap: "284B", pe: 10.2, divYield: 2.1, beta: 0.85,
    week52High: 255.00, week52Low: 175.00, eps: 18.50, revenueGrowthYoY: 12.0,
    ratingLabel: "Compra", ratingScore: 4,
  },
  F: {
    marketCap: "45B", pe: 11.5, divYield: 5.5, beta: 1.55,
    week52High: 15.50, week52Low: 9.80, eps: 1.15, revenueGrowthYoY: 5.0,
    ratingLabel: "Neutral", ratingScore: 3,
  },
  GM: {
    marketCap: "56B", pe: 5.5, divYield: 1.2, beta: 1.45,
    week52High: 55.00, week52Low: 30.00, eps: 9.20, revenueGrowthYoY: 8.0,
    ratingLabel: "Compra", ratingScore: 4,
  },
  SONY: {
    marketCap: "115B", pe: 16.5, divYield: 0.6, beta: 1.12,
    week52High: 105.00, week52Low: 78.00, eps: 5.45, revenueGrowthYoY: 9.0,
    ratingLabel: "Compra", ratingScore: 4,
  },
  BABA: {
    marketCap: "220B", pe: 12.5, divYield: 2.8, beta: 1.45,
    week52High: 117.00, week52Low: 63.00, eps: 7.20, revenueGrowthYoY: 7.0,
    ratingLabel: "Compra", ratingScore: 4,
  },
  TCEHY: {
    marketCap: "520B", pe: 18.5, divYield: 1.0, beta: 1.35,
    week52High: 65.00, week52Low: 35.00, eps: 3.12, revenueGrowthYoY: 10.0,
    ratingLabel: "Compra Fuerte", ratingScore: 5,
  },
  UBER: {
    marketCap: "148B", pe: 38.5, divYield: null, beta: 1.45,
    week52High: 87.00, week52Low: 40.00, eps: 1.10, revenueGrowthYoY: 15.0,
    ratingLabel: "Compra Fuerte", ratingScore: 5,
  },
  ABNB: {
    marketCap: "88B", pe: 18.2, divYield: null, beta: 1.25,
    week52High: 175.00, week52Low: 110.00, eps: 7.45, revenueGrowthYoY: 11.0,
    ratingLabel: "Compra", ratingScore: 4,
  },
  SPOT: {
    marketCap: "92B", pe: null, divYield: null, beta: 1.65,
    week52High: 480.00, week52Low: 185.00, eps: -0.25, revenueGrowthYoY: 20.0,
    ratingLabel: "Compra Fuerte", ratingScore: 5,
  },
  CAT: {
    marketCap: "185B", pe: 16.8, divYield: 1.5, beta: 1.10,
    week52High: 415.00, week52Low: 245.00, eps: 21.20, revenueGrowthYoY: 5.0,
    ratingLabel: "Compra", ratingScore: 4,
  },
  HON: {
    marketCap: "148B", pe: 24.5, divYield: 2.1, beta: 0.95,
    week52High: 235.00, week52Low: 185.00, eps: 9.45, revenueGrowthYoY: 3.0,
    ratingLabel: "Compra", ratingScore: 4,
  },
  LVMUY: {
    marketCap: "385B", pe: 22.4, divYield: 1.8, beta: 1.15,
    week52High: 205.00, week52Low: 135.00, eps: 7.20, revenueGrowthYoY: 9.0,
    ratingLabel: "Compra Fuerte", ratingScore: 5,
  },
  BAC: {
    marketCap: "348B", pe: 14.5, divYield: 2.2, beta: 1.12,
    week52High: 54.00, week52Low: 25.00, eps: 3.55, revenueGrowthYoY: 4.0,
    ratingLabel: "Compra", ratingScore: 4,
  },
  GS: {
    marketCap: "192B", pe: 16.4, divYield: 2.3, beta: 1.10,
    week52High: 605.00, week52Low: 305.00, eps: 32.40, revenueGrowthYoY: 15.0,
    ratingLabel: "Compra Fuerte", ratingScore: 5,
  },
  PYPL: {
    marketCap: "85B", pe: 18.5, divYield: null, beta: 1.45,
    week52High: 92.00, week52Low: 50.00, eps: 4.25, revenueGrowthYoY: 8.0,
    ratingLabel: "Compra", ratingScore: 4,
  },

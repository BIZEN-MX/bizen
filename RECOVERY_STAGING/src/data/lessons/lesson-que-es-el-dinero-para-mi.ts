...
export const lessonQueEsElDineroParaMiSteps: LessonStep[] = [
  // SLIDE 1 — FLASHCARD (Teoría)
  {
    ...
    data: {
      glossary: [
        { word: "Psicología del Dinero", definition: "Estudio de cómo nuestras emociones y sesgos afectan nuestras decisiones financieras." },
        { word: "FOMO", definition: "Fear of Missing Out (Miedo a perderse una corriente o tendencia)." },
        { word: "Gasto de Estatus", definition: "Compra motivada por el deseo de validar tu imagen ante los demás." },
        { word: "Comparación Social", definition: "La trampa de medir tu propio progreso basándote en la vida aparente de otros." }
      ]
    },
  ...
  // SLIDE 5 — Ejercicio (Calificado)
  {
    ...
    options: [
      ...
      { id: "opt-estatus", label: "Estatus", isCorrect: true, explanation: "Busca validación social a través del [[Gasto de Estatus|Compra impulsada para proyectar una imagen de éxito o riqueza a los demás]]." },
      { id: "opt-herramienta", label: "Herramienta", isCorrect: false },
      { id: "opt-presion", label: "Presión", isCorrect: false },
    ],
    isAssessment: true,
  ...
  // SLIDE 5-b — Impulse Meter (Feature 3: escenario mexicano real)
  {
    ...
    description: "Es la 1am. Ves la oferta en tu celular y dice: '¡Solo quedan 3 en stock!'. El [[FOMO|Fear of Missing Out: Miedo social a quedarse fuera de una oportunidad]] te está dominando. El corazón te late rápido.",
  ...
  // SLIDE 7 — Verdadero o Falso
  {
    ...
    correctValue: true,
    explanation: "La [[Psicología del Dinero|Estudio de cómo factores mentales, emocionales y culturales afectan nuestras finanzas]] demuestra que nuestras emociones son el motor principal de la mayoría de los gastos.",
    isAssessment: true,
    continueLabel: "Continuar",
    fullScreen: true,
  ...
  // SLIDE 14-b — Influence Detective
  {
    ...
    isAssessment: true,
    fullScreen: true,
    aiInsight: "La [[Comparación Social|Tendencia a medir tu valor personal basándote en los logros aparentes de los demás]] es uno de los mayores saboteadores de las finanzas personales. Comparar tu Capítulo 1 con el Capítulo 20 de alguien más es una trampa.",
  },

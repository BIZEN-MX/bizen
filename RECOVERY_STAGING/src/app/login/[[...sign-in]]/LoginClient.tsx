      ...
      >
        <div style={{ position: "relative", zIndex: 2 }}>
          ...
          <h1 style={{ marginTop: 48, lineHeight: 1, letterSpacing: "-0.04em", fontFamily: "var(--font-family)", fontWeight: 400 }}>
            <span style={{ color: "#ffffff", fontSize: 42, display: "block" }}>Aprende finanzas</span>
            <span style={{ fontSize: 42, display: "block", color: "#60a5fa" }}>haciendo.</span>
          </h1>
          <p style={{ marginTop: 24, color: "rgba(148,163,184,0.6)", fontSize: 16, lineHeight: 1.6, maxWidth: "90%" }}>
            Domina tu futuro financiero con la plataforma educativa más avanzada de México.
          </p>
        </div>
